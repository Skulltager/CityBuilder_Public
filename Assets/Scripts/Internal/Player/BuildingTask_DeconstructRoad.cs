...
public class BuildingTask_DeconstructRoad : BuildingTask
{
    public readonly new ChunkMapPointContent_RoadDeconstruction building;

    public BuildingTask_DeconstructRoad(ChunkMapPointContent_RoadDeconstruction building, int targetVillagers, int maxVillager)
    ...
    private void StartTask_DeconstructBuilding_Demolish(Villager villager, List<ChunkMapPointContent> dependencies, VillagerTaskPoint villagerTaskPoint)
    {
        ...
        BuildingTaskData_DeconstructRoad taskData = new BuildingTaskData_DeconstructRoad(dependencies, building, villagerTaskPoint, taskDescription);
        VillagerSubTask_DeconstructRoad task = new VillagerSubTask_DeconstructRoad(villager, this, taskData);
