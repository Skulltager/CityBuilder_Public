...
namespace SheetCodes
{
	...
	public class ResourceSpawnRecord : BaseRecord<ResourceSpawnIdentifier>
	{
		...
		[ColumnName("Possible World Resources")] [SerializeField] private WorldResourceIdentifier _possibleWorldResources = default;
		[NonSerialized] private WorldResourceRecord _possibleWorldResourcesRecord = default;
		public WorldResourceRecord PossibleWorldResources 
		{ 
			get 
			{ 
				if(_possibleWorldResourcesRecord == null)
					_possibleWorldResourcesRecord = ModelManager.WorldResourceModel.GetRecord(_possibleWorldResources);
				return _possibleWorldResourcesRecord; 
			} 
			set
			{
				if(!CheckEdit())
                ...
                if (value == null)
                    _possibleWorldResources = WorldResourceIdentifier.None;
                else
                    _possibleWorldResources = value.Identifier;
				_possibleWorldResourcesRecord = null;
			}
		}
        ...
        private void CopyData(ResourceSpawnRecord record)
        {
            ...
            record._possibleWorldResources = _possibleWorldResources;
        }
