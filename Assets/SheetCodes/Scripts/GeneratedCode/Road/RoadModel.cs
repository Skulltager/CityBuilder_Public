...
namespace SheetCodes
{
	...
	[Serializable]
	public class RoadModel : BaseModel<RoadRecord, RoadIdentifier>
	{
		[SerializeField] private RoadRecord[] records = default;
		protected override RoadRecord[] Records { get { return records; } }
